...
const vicoBloodPressureGet = vicoBaseUrl + '/patient.api/data/blood/pressure/record/commuicate-list'
...
const vicoWeightGet = vicoBaseUrl + '/patient.api/data/weight/record/commuicate-list'
...
const vicoDrugGet = vicoBaseUrl + '/patient.api/data/drug/record/commuicate-list'
...
const vicoDietGet = vicoBaseUrl + '/patient.api/data/diet/record/commuicate-list'
...
const vicoSportGet = vicoBaseUrl + '/patient.api/data/sport/record/commuicate-list'
...
const vicoDiscomfortGet = vicoBaseUrl + '/patient.api/data/discomfort/record/commuicate-list'
const vicoDiscomfortDelete = vicoBaseUrl + '/patient.api/data/discomfort/record/delete'
const vicoBloodGlucoseGet = vicoBaseUrl + '/patient.api/data/blood/glucose/record/commuicate-list'
