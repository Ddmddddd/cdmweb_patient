...
const vicoBloodPressureGet = vicoBaseUrl + '/patient.api/data/blood/pressure/record/list'
...
const vicoWeightGet = vicoBaseUrl + '/patient.api/data/weight/record/list'
...
const vicoDrugGet = vicoBaseUrl + '/patient.api/data/drug/record/list'
...
const vicoDietGet = vicoBaseUrl + '/patient.api/data/diet/record/list'
...
const vicoSportGet = vicoBaseUrl + '/patient.api/data/sport/record/list'
...
const vicoDiscomfortGet = vicoBaseUrl + '/patient.api/data/discomfort/record/list'
const vicoDiscomfortDelete = vicoBaseUrl + '/patient.api/data/discomfort/record/delete'
const vicoBloodGlucoseGet = vicoBaseUrl + '/patient.api/data/blood/glucose/record/list'
